...
import { posix, normalize, win32, sep } from 'bg/base/common/path';
import { startsWithIgnoreCase, rtrim } from 'bg/base/common/strings';
import { Schemas } from 'bg/base/common/network';
import { isLinux, isWindows, isMacintosh } from 'bg/base/common/platform';
import { isEqual, basename, relativePath } from 'bg/base/common/resources';
import { hasDriveLetter, isRootOrDriveLetter } from 'bg/base/common/extpath';
