...
import { basename, posix, extname } from 'bg/base/common/path';
import { startsWithUTF8BOM } from 'bg/base/common/strings';
import { match } from 'bg/base/common/glob';
import { URI } from 'bg/base/common/uri';
import { Schemas } from 'bg/base/common/network';
import { DataUri } from 'bg/base/common/resources';
...
function guessMimeTypeByPath(path: string, filename: string, associations: ITextMimeAssociationItem[]): string | null {
	...
	// association wins over all other.
