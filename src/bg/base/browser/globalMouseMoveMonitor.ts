...
import { IframeUtils } from 'bg/base/browser/iframe';
import { StandardMouseEvent } from 'bg/base/browser/mouseEvent';
import { IDisposable, DisposableStore } from 'bg/base/common/lifecycle';
import { isIOS } from 'bg/base/common/platform';
