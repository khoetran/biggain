...
import 'bg/css!./iconlabel';
import * as dom from 'bg/base/browser/dom';
import { HighlightedLabel } from 'bg/base/browser/ui/highlightedlabel/highlightedLabel';
import { IMatch } from 'bg/base/common/filters';
import { Disposable, IDisposable } from 'bg/base/common/lifecycle';
import { Range } from 'bg/base/common/range';
import { equals } from 'bg/base/common/objects';
import { IHoverDelegate } from 'bg/base/browser/ui/iconLabel/iconHoverDelegate';
import { IMarkdownString } from 'bg/base/common/htmlContent';
import { CancellationToken } from 'bg/base/common/cancellation';
import { setupCustomHover, setupNativeHover } from 'bg/base/browser/ui/iconLabel/iconLabelHover';
