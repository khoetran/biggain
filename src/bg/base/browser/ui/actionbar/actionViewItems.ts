...
import 'bg/css!./actionbar';
import * as platform from 'bg/base/common/platform';
import { Disposable } from 'bg/base/common/lifecycle';
import { SelectBox, ISelectOptionItem, ISelectBoxOptions } from 'bg/base/browser/ui/selectBox/selectBox';
import { IAction, IActionRunner, Action, IActionChangeEvent, ActionRunner, Separator } from 'bg/base/common/actions';
import * as types from 'bg/base/common/types';
import { EventType as TouchEventType, Gesture } from 'bg/base/browser/touch';
...
import { $, addDisposableListener, append, EventHelper, EventLike, EventType } from 'bg/base/browser/dom';
