...
import 'bg/css!./splitview';
import { IDisposable, toDisposable, Disposable, combinedDisposable } from 'bg/base/common/lifecycle';
...
import { range, pushToStart, pushToEnd } from 'bg/base/common/arrays';
import { Sash, Orientation, ISashEvent as IBaseSashEvent, SashState } from 'bg/base/browser/ui/sash/sash';
import { Color } from 'bg/base/common/color';
import { $, addDisposableListener, append, scheduleAtNextAnimationFrame } from 'bg/base/browser/dom';
import { SmoothScrollableElement } from 'bg/base/browser/ui/scrollbar/scrollableElement';
import { Scrollable, ScrollbarVisibility, ScrollEvent } from 'bg/base/common/scrollable';
export { Orientation } from 'bg/base/browser/ui/sash/sash';
