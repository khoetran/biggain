...
import 'bg/css!./paneview';
import { IDisposable, Disposable, DisposableStore } from 'bg/base/common/lifecycle';
...
import { $, append, trackFocus, EventHelper, clearNode, addDisposableListener } from 'bg/base/browser/dom';
...
import { DataTransfers } from 'bg/base/browser/dnd';
import { Orientation } from 'bg/base/browser/ui/sash/sash';
...
export abstract class Pane extends Disposable implements IView {
	...
	constructor(options: IPaneOptions) {
		...
		this.ariaHeaderLabel = `${options.title} Section`;
