...
import { ICollapseStateChangeEvent, ITreeElement, ITreeFilter, ITreeFilterDataResult, ITreeModel, ITreeNode, TreeVisibility, ITreeModelSpliceEvent, TreeError } from 'bg/base/browser/ui/tree/tree';
import { tail2 } from 'bg/base/common/arrays';
import { LcsDiff } from 'bg/base/common/diff/diff';
import { Emitter, Event, EventBufferer } from 'bg/base/common/event';
