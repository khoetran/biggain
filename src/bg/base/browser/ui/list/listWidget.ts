...
import { isNumber } from 'bg/base/common/types';
import { range, binarySearch, firstOrDefault } from 'bg/base/common/arrays';
import { memoize } from 'bg/base/common/decorators';
import * as platform from 'bg/base/common/platform';
import { Gesture } from 'bg/base/browser/touch';
import { KeyCode } from 'bg/base/common/keyCodes';
import { StandardKeyboardEvent, IKeyboardEvent } from 'bg/base/browser/keyboardEvent';
import { Event, Emitter, EventBufferer } from 'bg/base/common/event';
import { DomEmitter, stopEvent } from 'bg/base/browser/event';
