...
import { getOrDefault } from 'bg/base/common/objects';
import { IDisposable, dispose, Disposable, toDisposable, DisposableStore } from 'bg/base/common/lifecycle';
import { Gesture, EventType as TouchEventType, GestureEvent } from 'bg/base/browser/touch';
import { Event, Emitter } from 'bg/base/common/event';
import { SmoothScrollableElement } from 'bg/base/browser/ui/scrollbar/scrollableElement';
import { ScrollEvent, ScrollbarVisibility, INewScrollDimensions, Scrollable } from 'bg/base/common/scrollable';
...
import { Range, IRange } from 'bg/base/common/range';
import { equals, distinct } from 'bg/base/common/arrays';
import { DataTransfers, StaticDND, IDragAndDropData } from 'bg/base/browser/dnd';
import { disposableTimeout, Delayer } from 'bg/base/common/async';
import { isFirefox } from 'bg/base/browser/browser';
import { IMouseWheelEvent } from 'bg/base/browser/mouseEvent';
import { $, addDisposableListener, animate, getContentHeight, getContentWidth, getTopLeftOffset, scheduleAtNextAnimationFrame } from 'bg/base/browser/dom';
