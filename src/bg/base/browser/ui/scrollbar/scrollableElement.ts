...
import 'bg/css!./media/scrollbars';
import * as dom from 'bg/base/browser/dom';
import { FastDomNode, createFastDomNode } from 'bg/base/browser/fastDomNode';
import { IMouseEvent, StandardWheelEvent, IMouseWheelEvent } from 'bg/base/browser/mouseEvent';
import { ScrollbarHost } from 'bg/base/browser/ui/scrollbar/abstractScrollbar';
import { HorizontalScrollbar } from 'bg/base/browser/ui/scrollbar/horizontalScrollbar';
import { ScrollableElementChangeOptions, ScrollableElementCreationOptions, ScrollableElementResolvedOptions } from 'bg/base/browser/ui/scrollbar/scrollableElementOptions';
import { VerticalScrollbar } from 'bg/base/browser/ui/scrollbar/verticalScrollbar';
import { Widget } from 'bg/base/browser/ui/widget';
import { TimeoutTimer } from 'bg/base/common/async';
import { Emitter, Event } from 'bg/base/common/event';
import { IDisposable, dispose } from 'bg/base/common/lifecycle';
import * as platform from 'bg/base/common/platform';
import { INewScrollDimensions, INewScrollPosition, IScrollDimensions, IScrollPosition, ScrollEvent, Scrollable, ScrollbarVisibility } from 'bg/base/common/scrollable';
import { getZoomFactor } from 'bg/base/browser/browser';
