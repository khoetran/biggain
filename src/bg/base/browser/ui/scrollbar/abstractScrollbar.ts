...
import { GlobalMouseMoveMonitor, IStandardMouseMoveEventData, standardMouseMoveMerger } from 'bg/base/browser/globalMouseMoveMonitor';
import { IMouseEvent, StandardWheelEvent } from 'bg/base/browser/mouseEvent';
import { ScrollbarArrow, ScrollbarArrowOptions } from 'bg/base/browser/ui/scrollbar/scrollbarArrow';
import { ScrollbarState } from 'bg/base/browser/ui/scrollbar/scrollbarState';
import { ScrollbarVisibilityController } from 'bg/base/browser/ui/scrollbar/scrollbarVisibilityController';
import { Widget } from 'bg/base/browser/ui/widget';
import * as platform from 'bg/base/common/platform';
import { INewScrollPosition, Scrollable, ScrollbarVisibility } from 'bg/base/common/scrollable';
