...
import { EventType, Gesture, GestureEvent } from 'bg/base/browser/touch';
import { cleanMnemonic, IMenuOptions, Menu, MENU_ESCAPED_MNEMONIC_REGEX, MENU_MNEMONIC_REGEX, IMenuStyles, Direction } from 'bg/base/browser/ui/menu/menu';
import { ActionRunner, IAction, IActionRunner, SubmenuAction, Separator } from 'bg/base/common/actions';
import { RunOnceScheduler } from 'bg/base/common/async';
import { Event, Emitter } from 'bg/base/common/event';
import { KeyCode, ResolvedKeybinding, KeyMod } from 'bg/base/common/keyCodes';
import { Disposable, dispose, IDisposable } from 'bg/base/common/lifecycle';
import { withNullAsUndefined } from 'bg/base/common/types';
import { asArray } from 'bg/base/common/arrays';
import { ScanCodeUtils, ScanCode } from 'bg/base/common/scanCode';
...
export class MenuBar extends Disposable {
	...
	createOverflowMenu(): void {
		const label = this.options.compactMode !== undefined ? 'Application Menu' : 'More';
