...
import { IActionRunner, IAction, SubmenuAction, Separator, EmptySubmenuAction } from 'bg/base/common/actions';
import { ActionBar, ActionsOrientation, IActionViewItemProvider } from 'bg/base/browser/ui/actionbar/actionbar';
import { ResolvedKeybinding, KeyCode } from 'bg/base/common/keyCodes';
import { EventType, EventHelper, EventLike, isAncestor, addDisposableListener, append, $, clearNode, createStyleSheet, isInShadowDOM, getActiveElement, Dimension, IDomNodePagePosition } from 'bg/base/browser/dom';
import { StandardKeyboardEvent } from 'bg/base/browser/keyboardEvent';
import { RunOnceScheduler } from 'bg/base/common/async';
import { DisposableStore } from 'bg/base/common/lifecycle';
import { Color } from 'bg/base/common/color';
import { DomScrollableElement } from 'bg/base/browser/ui/scrollbar/scrollableElement';
import { ScrollbarVisibility, ScrollEvent } from 'bg/base/common/scrollable';
import { Event } from 'bg/base/common/event';
import { AnchorAlignment, layout, LayoutAnchorPosition } from 'bg/base/browser/ui/contextview/contextview';
import { isLinux, isMacintosh } from 'bg/base/common/platform';
import { Codicon, registerCodicon } from 'bg/base/common/codicons';
import { BaseActionViewItem, ActionViewItem, IActionViewItemOptions } from 'bg/base/browser/ui/actionbar/actionViewItems';
import { formatRule } from 'bg/base/browser/ui/codicons/codiconStyles';
import { isFirefox } from 'bg/base/browser/browser';
import { StandardMouseEvent } from 'bg/base/browser/mouseEvent';
import { stripIcons } from 'bg/base/common/iconLabels';
...
export class Menu extends ActionBar {
	...
	constructor(container: HTMLElement, actions: ReadonlyArray<IAction>, options: IMenuOptions = {}) {
		...
		this._register(addDisposableListener(scrollElement, EventType.MOUSE_UP, e => {
			// Absorb clicks in menu dead space
	...
	override updateTooltip(): void {
		...
		if (this.getAction().tooltip) {
			...
			if (this.options.keybinding) {
				title = `${title} (${this.options.keybinding})`;
			}
		}
