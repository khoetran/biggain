...
import 'bg/css!./sash';
import { Disposable, DisposableStore, toDisposable } from 'bg/base/common/lifecycle';
...
import { getElementsByTagName, EventHelper, createStyleSheet, append, $, EventLike } from 'bg/base/browser/dom';
import { DomEmitter } from 'bg/base/browser/event';
import { Delayer } from 'bg/base/common/async';
