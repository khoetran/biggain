...
import 'bg/css!./gridview';
import { Event, Emitter, Relay } from 'bg/base/common/event';
import { Orientation, Sash } from 'bg/base/browser/ui/sash/sash';
import { SplitView, IView as ISplitView, Sizing, LayoutPriority, ISplitViewStyles } from 'bg/base/browser/ui/splitview/splitview';
import { Disposable, IDisposable, toDisposable } from 'bg/base/common/lifecycle';
import { $ } from 'bg/base/browser/dom';
import { equals as arrayEquals, tail2 as tail } from 'bg/base/common/arrays';
import { Color } from 'bg/base/common/color';
import { clamp } from 'bg/base/common/numbers';
import { isUndefined } from 'bg/base/common/types';

export { Sizing, LayoutPriority } from 'bg/base/browser/ui/splitview/splitview';
