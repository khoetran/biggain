...
import { createElement, FormattedTextRenderOptions } from 'bg/base/browser/formattedTextRenderer';
import { onUnexpectedError } from 'bg/base/common/errors';
import { IMarkdownString, parseHrefAndDimensions, removeMarkdownEscapes } from 'bg/base/common/htmlContent';
import { defaultGenerator } from 'bg/base/common/idGenerator';
import * as marked from 'bg/base/common/marked/marked';
import { insane, InsaneOptions } from 'bg/base/common/insane/insane';
import { parse } from 'bg/base/common/marshalling';
import { cloneAndChange } from 'bg/base/common/objects';
import { escape } from 'bg/base/common/strings';
import { URI } from 'bg/base/common/uri';
import { FileAccess, Schemas } from 'bg/base/common/network';
import { markdownEscapeEscapedIcons } from 'bg/base/common/iconLabels';
import { resolvePath } from 'bg/base/common/resources';
...
function getInsaneOptions(options: { readonly isTrusted?: boolean }): InsaneOptions {
	const allowedSchemes = [
		...
		Schemas.data,
		Schemas.file,
		Schemas.biggainRemote,
		Schemas.biggainRemoteResource,
	];
