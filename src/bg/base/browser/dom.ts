...
import { IKeyboardEvent, StandardKeyboardEvent } from 'bg/base/browser/keyboardEvent';
import { IMouseEvent, StandardMouseEvent } from 'bg/base/browser/mouseEvent';
...
import { Disposable, DisposableStore, IDisposable, toDisposable } from 'bg/base/common/lifecycle';
import * as platform from 'bg/base/common/platform';
import { URI } from 'bg/base/common/uri';
import { FileAccess, RemoteAuthorities } from 'bg/base/common/network';
import { BrowserFeatures } from 'bg/base/browser/canIUse';
