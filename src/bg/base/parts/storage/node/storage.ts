...
import { mapToString, setToString } from 'bg/base/common/map';
import { basename } from 'bg/base/common/path';
...
class SQLiteStorageDatabaseLogger {
	...
	static readonly BIGGAIN_TRACE_STORAGE = 'BIGGAIN_TRACE_STORAGE';
	...
	constructor(options?: ISQLiteStorageDatabaseLoggingOptions) {
		if (options && typeof options.logTrace === 'function' && process.env[SQLiteStorageDatabaseLogger.BIGGAIN_TRACE_STORAGE]) {
