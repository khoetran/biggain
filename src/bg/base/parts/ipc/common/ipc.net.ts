...
import { IMessagePassingProtocol, IPCClient, IIPCLogger } from 'bg/base/parts/ipc/common/ipc';
import { IDisposable, Disposable, dispose } from 'bg/base/common/lifecycle';
