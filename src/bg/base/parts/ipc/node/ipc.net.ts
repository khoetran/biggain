...
import { ClientConnectionEvent, IPCServer } from 'bg/base/parts/ipc/common/ipc';
...
import { ISocket, Protocol, Client, ChunkStream, SocketCloseEvent, SocketCloseEventType } from 'bg/base/parts/ipc/common/ipc.net';
import { onUnexpectedError } from 'bg/base/common/errors';
import { Platform, platform } from 'bg/base/common/platform';
