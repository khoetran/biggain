...
import { Protocol, PersistentProtocol } from 'bg/base/parts/ipc/common/ipc.net';
import { createRandomIPCHandle, createStaticIPCHandle, NodeSocket } from 'bg/base/parts/ipc/node/ipc.net';
