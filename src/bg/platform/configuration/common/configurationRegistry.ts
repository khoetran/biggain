...
import { IJSONContributionRegistry, Extensions as JSONExtensions } from 'bg/platform/jsonschemas/common/jsonContributionRegistry';
...
export const resourceLanguageSettingsSchemaId = 'biggain://schemas/settings/resourceLanguage';
...
class ConfigurationRegistry implements IConfigurationRegistry {
	...
	constructor() {
		...
		this.defaultLanguageConfigurationOverridesNode = {
			id: 'defaultOverrides',
			title: "Default Language Configuration Overrides",
			properties: {}
		};
			...
			for (const key in defaultConfiguration) {
				...
				if (OVERRIDE_PROPERTY_PATTERN.test(key)) {
					...
					const property: IConfigurationPropertySchema = {
						...
						description: `Configure settings to be overridden for ${key} language.`,
