...
import { JSONPath, parse, ParseError } from 'bg/base/common/json';
import { setProperty } from 'bg/base/common/jsonEdit';
import { Edit, FormattingOptions } from 'bg/base/common/jsonFormatter';
import { URI } from 'bg/base/common/uri';
import { IEnvironmentService } from 'bg/platform/environment/common/environment';
import { FileOperationError, FileOperationResult, IFileService } from 'bg/platform/files/common/files';
