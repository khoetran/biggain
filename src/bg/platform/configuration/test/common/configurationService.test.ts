...
import { ConfigurationService } from 'bg/platform/configuration/common/configurationService';
...
import { ConfigurationTarget } from 'bg/platform/configuration/common/configuration';
