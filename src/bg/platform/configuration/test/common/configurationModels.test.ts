...
import { ConfigurationModel, DefaultConfigurationModel, ConfigurationChangeEvent, ConfigurationModelParser, Configuration } from 'bg/platform/configuration/common/configurationModels';
import { Extensions, IConfigurationRegistry } from 'bg/platform/configuration/common/configurationRegistry';
...
suite('Configuration', () => {
	...
	test('Test inspect for overrideIdentifiers', () => {
		...
		const testObject: Configuration = new Configuration(defaultConfigurationModel, userConfigurationModel, new ConfigurationModel());
