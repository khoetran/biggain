...
import { FileStorage } from 'bg/platform/state/electron-main/stateMainService';
import { Promises, writeFileSync } from 'bg/base/node/pfs';
import { ILogService, NullLogService } from 'bg/platform/log/common/log';
