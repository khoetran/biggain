...
import { KeyCode, KeyCodeUtils, Keybinding, SimpleKeybinding } from 'bg/base/common/keyCodes';
import { OperatingSystem } from 'bg/base/common/platform';
import { BaseResolvedKeybinding } from 'bg/platform/keybinding/common/baseResolvedKeybinding';
