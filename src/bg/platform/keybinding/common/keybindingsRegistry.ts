...
import { KeyCode, Keybinding, SimpleKeybinding, createKeybinding } from 'bg/base/common/keyCodes';
import { OS, OperatingSystem } from 'bg/base/common/platform';
import { CommandsRegistry, ICommandHandler, ICommandHandlerDescription } from 'bg/platform/commands/common/commands';
import { ContextKeyExpression } from 'bg/platform/contextkey/common/contextkey';
