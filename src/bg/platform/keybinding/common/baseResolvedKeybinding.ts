...
import { OperatingSystem } from 'bg/base/common/platform';
import { illegalArgument } from 'bg/base/common/errors';
import { Modifiers, UILabelProvider, AriaLabelProvider, ElectronAcceleratorLabelProvider, UserSettingsLabelProvider } from 'bg/base/common/keybindingLabels';
import { ResolvedKeybinding, ResolvedKeybindingPart } from 'bg/base/common/keyCodes';
