...
import { MenuRegistry, MenuId, isIMenuItem } from 'bg/platform/actions/common/actions';
import { MenuService } from 'bg/platform/actions/common/menuService';
import { DisposableStore } from 'bg/base/common/lifecycle';
import { NullCommandService } from 'bg/platform/commands/common/commands';
import { MockContextKeyService } from 'bg/platform/keybinding/test/common/mockKeybindingService';
