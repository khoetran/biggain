...
import { IMenu, IMenuActionOptions, IMenuItem, IMenuService, isIMenuItem, ISubmenuItem, MenuId, MenuItemAction, MenuRegistry, SubmenuItemAction, ILocalizedString } from 'bg/platform/actions/common/actions';
import { ICommandService } from 'bg/platform/commands/common/commands';
import { IContextKeyService, ContextKeyExpression } from 'bg/platform/contextkey/common/contextkey';
