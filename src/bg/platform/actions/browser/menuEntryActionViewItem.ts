...
import 'bg/css!./menuEntryActionViewItem';
import { addDisposableListener, asCSSUrl, ModifierKeyEmitter, append, EventType, $ } from 'bg/base/browser/dom';
import { IAction, IRunEvent, Separator, SubmenuAction } from 'bg/base/common/actions';
import { IDisposable, toDisposable, MutableDisposable, DisposableStore } from 'bg/base/common/lifecycle';
import { ICommandAction, IMenu, IMenuActionOptions, MenuItemAction, SubmenuItemAction, Icon, IMenuService } from 'bg/platform/actions/common/actions';
import { IContextMenuService } from 'bg/platform/contextview/browser/contextView';
import { IKeybindingService } from 'bg/platform/keybinding/common/keybinding';
import { UILabelProvider } from 'bg/base/common/keybindingLabels';
...
import { isWindows, isLinux, OS } from 'bg/base/common/platform';
