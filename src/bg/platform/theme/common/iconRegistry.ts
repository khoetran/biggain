...
import * as Codicons from 'bg/base/common/codicons';
	...
	private iconSchema: IJSONSchema & { properties: IJSONSchemaMap } = {
		definitions: {
			icons: {
				type: 'object',
				properties: {
					fontId: { type: 'string', description: 'The id of the font to use. If not set, the font that is defined first is used.' },
					fontCharacter: { type: 'string', description: 'The font character associated with the icon definition.' }
				},
...
export const iconsSchemaId = 'biggain://schemas/icons';
...
export const widgetClose = registerIcon('widget-close', Codicons.Codicon.close, 'Icon for the close action in widgets.');

export const gotoPreviousLocation = registerIcon('goto-previous-location', Codicons.Codicon.arrowUp, 'Icon for goto previous editor location.');
export const gotoNextLocation = registerIcon('goto-next-location', Codicons.Codicon.arrowDown, 'Icon for goto next editor location.');
