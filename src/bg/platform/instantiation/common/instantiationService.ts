...
import { illegalState } from 'bg/base/common/errors';
import { Graph } from 'bg/platform/instantiation/common/graph';
import { SyncDescriptor } from 'bg/platform/instantiation/common/descriptors';
import { ServiceIdentifier, IInstantiationService, ServicesAccessor, _util, optional } from 'bg/platform/instantiation/common/instantiation';
import { ServiceCollection } from 'bg/platform/instantiation/common/serviceCollection';
import { IdleValue } from 'bg/base/common/async';
