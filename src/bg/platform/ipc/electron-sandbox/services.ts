...
import { IChannel, IServerChannel, ProxyChannel } from 'bg/base/parts/ipc/common/ipc';
import { SyncDescriptor } from 'bg/platform/instantiation/common/descriptors';
import { registerSingleton } from 'bg/platform/instantiation/common/extensions';
import { createDecorator, ServiceIdentifier } from 'bg/platform/instantiation/common/instantiation';
