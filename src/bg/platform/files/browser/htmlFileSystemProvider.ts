...
import { IFileSystemProviderWithFileReadWriteCapability, FileSystemProviderCapabilities, IFileChange, IWatchOptions, IStat, FileOverwriteOptions, FileType, FileDeleteOptions, FileWriteOptions } from 'bg/platform/files/common/files';
import { Disposable, IDisposable } from 'bg/base/common/lifecycle';
import { Event, Emitter } from 'bg/base/common/event';
import { extUri } from 'bg/base/common/resources';
