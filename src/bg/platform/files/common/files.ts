...
import { sep } from 'bg/base/common/path';
import { URI } from 'bg/base/common/uri';
import { IExpression } from 'bg/base/common/glob';
import { createDecorator } from 'bg/platform/instantiation/common/instantiation';
import { Event } from 'bg/base/common/event';
import { startsWithIgnoreCase } from 'bg/base/common/strings';
import { IDisposable } from 'bg/base/common/lifecycle';
import { isNumber } from 'bg/base/common/types';
import { VSBuffer, VSBufferReadable, VSBufferReadableStream } from 'bg/base/common/buffer';
import { ReadableStreamEvents } from 'bg/base/common/stream';
