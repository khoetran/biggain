...
import { IDisposable, Disposable, toDisposable, dispose, combinedDisposable } from 'bg/base/common/lifecycle';
import { FileSystemProviderCapabilities, IFileChange, IWatchOptions, IStat, FileType, FileDeleteOptions, FileOverwriteOptions, FileWriteOptions, FileOpenOptions, FileSystemProviderErrorCode, createFileSystemProviderError, FileSystemProviderError, IFileSystemProviderWithFileReadWriteCapability, IFileSystemProviderWithFileReadStreamCapability, IFileSystemProviderWithOpenReadWriteCloseCapability, FileReadStreamOptions, IFileSystemProviderWithFileFolderCopyCapability, isFileOpenForWriteOptions } from 'bg/platform/files/common/files';
import { URI } from 'bg/base/common/uri';
import { Event, Emitter } from 'bg/base/common/event';
import { isLinux, isWindows } from 'bg/base/common/platform';
import { SymlinkSupport, RimRafMode, IDirent, Promises } from 'bg/base/node/pfs';
import { normalize, basename, dirname } from 'bg/base/common/path';
import { joinPath } from 'bg/base/common/resources';
import { isEqual } from 'bg/base/common/extpath';
import { retry, ThrottledDelayer } from 'bg/base/common/async';
import { ILogService, LogLevel } from 'bg/platform/log/common/log';
import { IDiskFileChange, toFileChanges, ILogMessage } from 'bg/platform/files/node/watcher/watcher';
import { FileWatcher as UnixWatcherService } from 'bg/platform/files/node/watcher/unix/watcherService';
import { FileWatcher as WindowsWatcherService } from 'bg/platform/files/node/watcher/win32/watcherService';
import { FileWatcher as NsfwWatcherService } from 'bg/platform/files/node/watcher/nsfw/watcherService';
import { FileWatcher as NodeJSWatcherService } from 'bg/platform/files/node/watcher/nodejs/watcherService';
import { CancellationToken } from 'bg/base/common/cancellation';
import { ReadableStreamEvents, newWriteableStream } from 'bg/base/common/stream';
import { readFileIntoStream } from 'bg/platform/files/common/io';
import { insert } from 'bg/base/common/arrays';
