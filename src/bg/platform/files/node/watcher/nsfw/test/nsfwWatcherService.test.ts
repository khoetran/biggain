...
import { IWatcherRequest } from 'bg/platform/files/node/watcher/nsfw/watcher';
...
suite('NSFW Watcher Service', async () => {
	...
	const { NsfwWatcherService } = await import('bg/platform/files/node/watcher/nsfw/nsfwWatcherService');
