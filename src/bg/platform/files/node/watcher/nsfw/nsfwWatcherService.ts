...
import { ParsedPattern, parse } from 'bg/base/common/glob';
...
import { IWatcherService, IWatcherRequest } from 'bg/platform/files/node/watcher/nsfw/watcher';
...
import { realcaseSync, realpathSync } from 'bg/base/node/extpath';
