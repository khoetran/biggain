...
import { IWatcherRequest, IWatcherService } from 'bg/platform/files/node/watcher/nsfw/watcher';
	...
	private startWatching(): void {
		const client = this._register(new Client(
			FileAccess.asFileUri('bootstrap-fork', require).fsPath,
			{
				...
				env: {
					BIGGAIN_AMD_ENTRYPOINT: 'bg/platform/files/node/watcher/nsfw/watcherApp',
