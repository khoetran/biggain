...
import { IWatcherRequest } from 'bg/platform/files/node/watcher/unix/watcher';
...
suite('Chokidar normalizeRoots', async () => {
	...
	const { normalizeRoots } = await import('bg/platform/files/node/watcher/unix/chokidarWatcherService');
