...
import { match, ParsedPattern, parse } from 'bg/base/common/glob';
import { isEqualOrParent } from 'bg/base/common/extpath';
...
import { realcaseSync } from 'bg/base/node/extpath';
import { isMacintosh, isLinux } from 'bg/base/common/platform';
import { IDiskFileChange, normalizeFileChanges, ILogMessage } from 'bg/platform/files/node/watcher/watcher';
import { IWatcherRequest, IWatcherService, IWatcherOptions } from 'bg/platform/files/node/watcher/unix/watcher';
import { Emitter } from 'bg/base/common/event';
import { equals } from 'bg/base/common/arrays';
