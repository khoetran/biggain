...
import { FileOperation, FileOperationError, FileOperationEvent, FileOperationResult, FileSystemProviderErrorCode, FileType, IFileStatWithMetadata } from 'bg/platform/files/common/files';
import { NullLogService } from 'bg/platform/log/common/log';
import { DisposableStore } from 'bg/base/common/lifecycle';
import { IIndexedDBFileSystemProvider, IndexedDB, INDEXEDDB_LOGS_OBJECT_STORE, INDEXEDDB_USERDATA_OBJECT_STORE } from 'bg/platform/files/browser/indexedDBFileSystemProvider';
import { assertIsDefined } from 'bg/base/common/types';
import { basename, joinPath } from 'bg/base/common/resources';
import { bufferToReadable, bufferToStream, VSBuffer, VSBufferReadable, VSBufferReadableStream } from 'bg/base/common/buffer';
