...
import { isEqual, isEqualOrParent } from 'bg/base/common/extpath';
import { FileChangeType, FileChangesEvent, isParent } from 'bg/platform/files/common/files';
import { isLinux, isMacintosh, isWindows } from 'bg/base/common/platform';
import { toResource } from 'bg/base/test/common/utils';
