...
import { FileChangesEvent, FileChangeType, IFileChange } from 'bg/platform/files/common/files';
import { URI as uri } from 'bg/base/common/uri';
import { IDiskFileChange, normalizeFileChanges, toFileChanges } from 'bg/platform/files/node/watcher/watcher';
