...
import { FileService } from 'bg/platform/files/common/fileService';
import { Schemas } from 'bg/base/common/network';
import { DiskFileSystemProvider } from 'bg/platform/files/node/diskFileSystemProvider';
import { flakySuite, getRandomTestPath, getPathFromAmdModule } from 'bg/base/test/node/testUtils';
import { join, basename, dirname, posix } from 'bg/base/common/path';
import { Promises, rimrafSync } from 'bg/base/node/pfs';
...
import { FileOperation, FileOperationEvent, IFileStat, FileOperationResult, FileSystemProviderCapabilities, FileChangeType, IFileChange, FileOperationError, etag, IStat, IFileStatWithMetadata, IReadFileOptions, FilePermission, NotModifiedSinceFileOperationError } from 'bg/platform/files/common/files';
...
import { isEqual, joinPath } from 'bg/base/common/resources';
import { VSBuffer, VSBufferReadable, streamToBufferReadableStream, VSBufferReadableStream, bufferToReadable, bufferToStream, streamToBuffer } from 'bg/base/common/buffer';
