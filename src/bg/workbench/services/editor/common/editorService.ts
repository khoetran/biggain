...
import { IResourceEditorInput, IEditorOptions, IResourceEditorInputIdentifier } from 'bg/platform/editor/common/editor';
import { IEditorInput, IEditorPane, GroupIdentifier, IEditorInputWithOptions, IEditorIdentifier, ISaveOptions, IRevertOptions, EditorsOrder, IVisibleEditorPane, IEditorCloseEvent, IUntypedEditorInput } from 'bg/workbench/common/editor';
import { Event } from 'bg/base/common/event';
import { IEditorGroup, IEditorReplacement, isEditorGroup } from 'bg/workbench/services/editor/common/editorGroupsService';
