...
import { Composite } from 'bg/workbench/browser/composite';
import { IEditorPane, GroupIdentifier, IEditorMemento, IEditorOpenContext, isEditorInput } from 'bg/workbench/common/editor';
import { EditorInput } from 'bg/workbench/common/editor/editorInput';
import { IThemeService } from 'bg/platform/theme/common/themeService';
import { CancellationToken } from 'bg/base/common/cancellation';
import { IEditorGroup, IEditorGroupsService } from 'bg/workbench/services/editor/common/editorGroupsService';
import { IStorageService, StorageScope, StorageTarget } from 'bg/platform/storage/common/storage';
import { LRUCache, Touch } from 'bg/base/common/map';
import { URI } from 'bg/base/common/uri';
import { Event } from 'bg/base/common/event';
import { isEmptyObject } from 'bg/base/common/types';
import { DEFAULT_EDITOR_MIN_DIMENSIONS, DEFAULT_EDITOR_MAX_DIMENSIONS } from 'bg/workbench/browser/parts/editor/editor';
import { MementoObject } from 'bg/workbench/common/memento';
import { joinPath, IExtUri, isEqual } from 'bg/base/common/resources';
import { indexOfPath } from 'bg/base/common/extpath';
...
import { IEditorOptions } from 'bg/platform/editor/common/editor';
...
export abstract class EditorPane extends Composite implements IEditorPane {
	...
	protected getEditorMemento<T>(editorGroupService: IEditorGroupsService, configurationService: IConfigurationService, key: string, limit: number = 10): IEditorMemento<T> {
...
export class EditorMemento<T> extends Disposable implements IEditorMemento<T> {
	...
	private updateConfiguration(): void {
		this.shareEditorState = this.configurationService.getValue('workbench.editor.sharedViewState') === true;
	}
