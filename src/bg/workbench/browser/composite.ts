...
import { IAction, IActionRunner, ActionRunner } from 'bg/base/common/actions';
import { Component } from 'bg/workbench/common/component';
import { IComposite, ICompositeControl } from 'bg/workbench/common/composite';
import { Event, Emitter } from 'bg/base/common/event';
import { IThemeService } from 'bg/platform/theme/common/themeService';
import { IConstructorSignature0, IInstantiationService } from 'bg/platform/instantiation/common/instantiation';
import { trackFocus, Dimension } from 'bg/base/browser/dom';
import { IStorageService } from 'bg/platform/storage/common/storage';
